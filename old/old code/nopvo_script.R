...
load("/Users/Rebecca/Dropbox/research/NOPVO/analysis/scripts/NOPVO_cleaned.RData")
...
nopvo$Q48 <- recode(nopvo$Q48, "'Both, Dutch and another nationality' = 'only Dutch'")
